...
exports.runUnopangyoScenario = runUnopangyoScenario;
const playwright_1 = require("playwright");
async function runUnopangyoScenario(options) {
    ...
    try {
        ...
        options?.onStatusUpdate?.({ name: 'unopangyo', status: 'fail', message: '오류 발생: ' + e.message });
        await browser.close();
        return 'fail';
    }
}
...
//# sourceMappingURL=unopangyo.js.map